...
export default function SetAvatar() {
    ...
    const setProfileImg = async () => {
        if(selectedAvatar === undefined) {
            toast.error("Please select an avatar", toastOpthions)
        } else {
            ...
            if(data.isSet) {
                ...
                toast.error("Error setting avatar. Pleas try again" , toastOpthions);
            }
        }
    };
    useEffect( async () => {
                ...
                isLoading ? <Container>
                    <img src={loader} alt="loader"  className='loader'/>
                       ...
                       <div className="title-container">
                           <h1>Pick an avatar as your profile img</h1>    
                       </div>
